...
// Useful when we emit events rarely and want to get a last event during X period
// As example we are clicking on a page and during next 4 sec we are waiting what value will last
// Time is being counted from first emit
